...
from resources.university import blp as UniversityBlueprint
...
def create_app(db_url=None):
    ...
    def check_if_token_in_blocklisst(jwt_header, jwt_payload):
        return jwt_payload["jti"] in BLOCKLIST
    
    @jwt.expired_token_loader
    def expired_token_callback(jwt_header, jwt_payload):
        return(
            jsonify({"message": "The token has expired.", "error": "The token_expired"}),401
        )
